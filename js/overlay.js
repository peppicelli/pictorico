(function($) {
    $(document).ready(function() {
        ...
        window.displayFlickrGallery = function(flickrGalleryID, title, link, link_title) {
            $("#overlay-title").html(title);
            $("#overlay-link").html('<a href="' + link + '">' + link_title + '</a>');
        ...
        window.displayVideo = function(youTubeURL, title, link, link_title) {
            $("#overlay-title").html(title);
            $("#overlay-link").html('<a href="' + link + '">' + link_title + '</a>');
