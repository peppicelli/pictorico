(function($) {
    $(document).ready(function() {
        ...
        window.displayFlickrGallery = function(flickrGalleryID, title, link) {
            $("#overlay-title").html(title);
            $("#overlay-link").html('<a href="' + link + '">Comments</a>');
        ...
        window.displayVideo = function(youTubeURL, title, link) {
            $("#overlay-title").html(title);
            $("#overlay-link").html('<a href="' + link + '">Comments</a>');
